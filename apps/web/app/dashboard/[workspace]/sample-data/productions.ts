...
export const PRODUCTIONS_SAMPLE_DATA = {
  table: {
    ...
    data: [
      ...
      { id: '3', title: 'Queensland Stories', status: 'post-production', stage: '', startDate: '2026-02-01' },
  ...
  board: {
    ...
    cards: [
      ...
      { id: 'c3', laneId: 'post-production', title: 'Queensland Stories', subtitle: 'Editing' },
  ...
  timeline: {
    tasks: [
      ...
      { id: 't3', title: 'Queensland Stories', start: '2026-01-10', end: '2026-03-25', progress: 85, color: '#22c55e' },
