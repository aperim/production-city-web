...
export const MEDIA: Record<string, MediaSource> = {
  ...
  "vision-australia": media("vision-australia", "Australian coastline — lush green hills meeting the ocean", "Caleb Russell", "https://www.pexels.com/@caleb-russell-1573299", "#787966"),
