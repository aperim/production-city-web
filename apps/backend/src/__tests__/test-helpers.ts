...
const SCHEMA_STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS "AnnouncementCategory" ("id" TEXT NOT NULL PRIMARY KEY, "name" TEXT NOT NULL, "slug" TEXT NOT NULL, "description" TEXT, "sortOrder" INTEGER NOT NULL DEFAULT 0, "isActive" INTEGER NOT NULL DEFAULT 1, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
  ...
  `CREATE TABLE IF NOT EXISTS "AnnouncementTag" ("id" TEXT NOT NULL PRIMARY KEY, "name" TEXT NOT NULL, "slug" TEXT NOT NULL, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
  ...
  `CREATE TABLE IF NOT EXISTS "AnnouncementCategoryLink" ("announcementId" TEXT NOT NULL, "categoryId" TEXT NOT NULL, PRIMARY KEY ("announcementId", "categoryId"), CONSTRAINT "AnnouncementCategoryLink_announcementId_fkey" FOREIGN KEY ("announcementId") REFERENCES "Announcement" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "AnnouncementCategoryLink_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "AnnouncementCategory" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
  `CREATE TABLE IF NOT EXISTS "AnnouncementTagLink" ("announcementId" TEXT NOT NULL, "tagId" TEXT NOT NULL, PRIMARY KEY ("announcementId", "tagId"), CONSTRAINT "AnnouncementTagLink_announcementId_fkey" FOREIGN KEY ("announcementId") REFERENCES "Announcement" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "AnnouncementTagLink_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES "AnnouncementTag" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
  `CREATE TABLE IF NOT EXISTS "AnnouncementRoleVisibility" ("announcementId" TEXT NOT NULL, "roleId" TEXT NOT NULL, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("announcementId", "roleId"), CONSTRAINT "AnnouncementRoleVisibility_announcementId_fkey" FOREIGN KEY ("announcementId") REFERENCES "Announcement" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "AnnouncementRoleVisibility_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
  `CREATE TABLE IF NOT EXISTS "CategorySubscription" ("id" TEXT NOT NULL PRIMARY KEY, "userId" TEXT NOT NULL, "categoryId" TEXT NOT NULL, "channel" TEXT NOT NULL, "status" TEXT NOT NULL DEFAULT 'pending', "confirmationTokenHash" TEXT, "confirmedAt" DATETIME, "declinedAt" DATETIME, "expiresAt" DATETIME NOT NULL, "subscribedById" TEXT NOT NULL, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "CategorySubscription_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "CategorySubscription_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "AnnouncementCategory" ("id") ON DELETE RESTRICT ON UPDATE CASCADE, CONSTRAINT "CategorySubscription_subscribedById_fkey" FOREIGN KEY ("subscribedById") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE)`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "CategorySubscription_userId_categoryId_channel_key" ON "CategorySubscription"("userId", "categoryId", "channel")`,
  `CREATE INDEX IF NOT EXISTS "CategorySubscription_userId_idx" ON "CategorySubscription"("userId")`,
  `CREATE INDEX IF NOT EXISTS "CategorySubscription_categoryId_idx" ON "CategorySubscription"("categoryId")`,
  `CREATE INDEX IF NOT EXISTS "CategorySubscription_status_idx" ON "CategorySubscription"("status")`,
  `CREATE INDEX IF NOT EXISTS "CategorySubscription_expiresAt_idx" ON "CategorySubscription"("expiresAt")`,
  `CREATE INDEX IF NOT EXISTS "CategorySubscription_confirmationTokenHash_idx" ON "CategorySubscription"("confirmationTokenHash")`,
  `CREATE TABLE IF NOT EXISTS "AnnouncementDelivery" ("id" TEXT NOT NULL PRIMARY KEY, "announcementId" TEXT NOT NULL, "subscriptionId" TEXT NOT NULL, "userId" TEXT NOT NULL, "channel" TEXT NOT NULL, "status" TEXT NOT NULL DEFAULT 'queued', "externalMessageId" TEXT, "errorMessage" TEXT, "bounceType" TEXT, "twilioErrorCode" TEXT, "openedAt" DATETIME, "clickedAt" DATETIME, "sentAt" DATETIME, "deliveredAt" DATETIME, "lastEventAt" DATETIME, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "AnnouncementDelivery_announcementId_fkey" FOREIGN KEY ("announcementId") REFERENCES "Announcement" ("id") ON DELETE RESTRICT ON UPDATE CASCADE, CONSTRAINT "AnnouncementDelivery_subscriptionId_fkey" FOREIGN KEY ("subscriptionId") REFERENCES "CategorySubscription" ("id") ON DELETE RESTRICT ON UPDATE CASCADE, CONSTRAINT "AnnouncementDelivery_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE)`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "AnnouncementDelivery_announcementId_userId_channel_key" ON "AnnouncementDelivery"("announcementId", "userId", "channel")`,
  `CREATE INDEX IF NOT EXISTS "AnnouncementDelivery_announcementId_idx" ON "AnnouncementDelivery"("announcementId")`,
  `CREATE INDEX IF NOT EXISTS "AnnouncementDelivery_userId_idx" ON "AnnouncementDelivery"("userId")`,
  `CREATE INDEX IF NOT EXISTS "AnnouncementDelivery_status_idx" ON "AnnouncementDelivery"("status")`,
  `CREATE INDEX IF NOT EXISTS "AnnouncementDelivery_subscriptionId_idx" ON "AnnouncementDelivery"("subscriptionId")`,
  `CREATE INDEX IF NOT EXISTS "AnnouncementDelivery_externalMessageId_channel_idx" ON "AnnouncementDelivery"("externalMessageId", "channel")`,
  `CREATE INDEX IF NOT EXISTS "AnnouncementDelivery_announcementId_status_idx" ON "AnnouncementDelivery"("announcementId", "status")`,
  `CREATE TABLE IF NOT EXISTS "DeliveryEvent" ("id" TEXT NOT NULL PRIMARY KEY, "deliveryId" TEXT NOT NULL, "eventType" TEXT NOT NULL, "source" TEXT NOT NULL, "providerEventId" TEXT, "metadata" TEXT, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "DeliveryEvent_deliveryId_fkey" FOREIGN KEY ("deliveryId") REFERENCES "AnnouncementDelivery" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "DeliveryEvent_deliveryId_providerEventId_key" ON "DeliveryEvent"("deliveryId", "providerEventId")`,
  `CREATE INDEX IF NOT EXISTS "DeliveryEvent_deliveryId_idx" ON "DeliveryEvent"("deliveryId")`,
  `CREATE TABLE IF NOT EXISTS "SmsSuppression" ("id" TEXT NOT NULL PRIMARY KEY, "phoneNumber" TEXT NOT NULL, "reason" TEXT NOT NULL, "providerEventId" TEXT, "removedAt" DATETIME, "removedBy" TEXT, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "SmsSuppression_removedBy_fkey" FOREIGN KEY ("removedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE)`,
