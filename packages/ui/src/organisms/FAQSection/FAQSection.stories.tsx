...
const items = [
  ...
  { question: "Where is Production City located?", answer: "The primary campus is planned for Queensland, Australia, with additional locations in Singapore, Hawaii, Europe, and the USA." },
